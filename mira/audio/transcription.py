...
This module owns mira's transcription behavior: config resolution,
...
HTTP details; those live in ``mira.providers.transcription``.
"""
...
from mira.config.loader import resolve_env_refs
from mira.config.paths import get_media_dir
from mira.providers.registry import find_by_name
from mira.utils.media_decode import FileSizeExceeded, save_base64_data_url
