...
class SkillsLoader:
    ...
    def _parse_mira_metadata(self, raw: object) -> dict:
        """Extract mira/openclaw metadata from a frontmatter field.
        ...
        if not isinstance(data, dict):
            return {}
        payload = data.get("mira", data.get("openclaw", {}))
    ...
    def _get_skill_meta(self, name: str) -> dict:
        ...
        return self._parse_mira_metadata(raw_meta.get("metadata"))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        return [
            ...
            and (
                self._parse_mira_metadata(meta.get("metadata")).get("always")
                or meta.get("always")
            )
        ]
