...
from mira.utils.helpers import build_image_content_blocks
...
def _validate_url_safe(url: str) -> tuple[bool, str]:
    ...
    from mira.security.network import validate_url_target
...
def _resolve_url_safe(url: str) -> tuple[bool, str, tuple[str, ...]]:
    ...
    from mira.security.network import resolve_url_target
...
def _fetch_client_kwargs(proxy: str | None, timeout: float) -> dict[str, Any]:
    from mira.security.network import httpx_env_proxy_mounts
...
def _unsafe_url_request_error(exc: BaseException) -> str | None:
    from mira.security.network import UnsafeURLRequestError
