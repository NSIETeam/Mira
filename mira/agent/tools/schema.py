"""JSON Schema fragment types: all subclass :class:`~mira.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~mira.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~mira.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~mira.agent.tools.base.Schema`.
...
from mira.agent.tools.base import Schema
