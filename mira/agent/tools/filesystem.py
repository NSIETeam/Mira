...
from mira.agent.tools.file_state import FileStates, _hash_file, current_file_states
from mira.agent.tools.path_utils import resolve_workspace_path
...
from mira.security.workspace_access import current_tool_workspace
from mira.utils.helpers import build_image_content_blocks, detect_image_mime
...
class _FsTool(Tool):
    ...
    def create(cls, ctx: Any) -> Tool:
        ...
        # capability and is withheld from subagents unless a future MemoryView grants it.
        extra_read_allowed_files = []
        if getattr(ctx, "scope", "core") != "subagent":
            extra_read_allowed_files.append(resolved_agent_workspace / "memory" / "history.jsonl")
        return cls(
...
class ReadFileTool(_FsTool):
    ...
    def _read_pdf(self, fp: Path, pages: str | None) -> str:
        from mira.utils.document import PdfPageRangeError, PdfSafetyError, extract_pdf_pages
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from mira.utils.document import extract_text
