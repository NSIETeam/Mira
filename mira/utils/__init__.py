...
from mira.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "mira.webui.thread_disk",
    "webui_transcript": "mira.webui.transcript",
    "webui_turn_helpers": "mira.session.webui_turns",
}
