...
from mira.utils.restart import (  # noqa: E402
...
def _run_gateway(
    ...
    *,
    ...
    from mira.session.keys import session_key_for_channel
...
def doctor(
    config: str | None = typer.Option(None, "--config", "-c", help="Path to config file"),
    workspace: str | None = typer.Option(None, "--workspace", "-w", help="Workspace directory"),
    profile: str = typer.Option("standard", "--profile", help="Doctor profile: standard or lightweight"),
