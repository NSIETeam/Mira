...
module maps mira's richer SDK events into a compact set of durable event
...
from mira.mira import RunResult, StreamEvent
from mira.session.goal_state import sustained_goal_active
from mira.session.turn_continuation import internal_continuation_pending
...
def merge_snapshot_with_session_metadata(
    ...
    session-layer runtime signals that already exist in mira today:
