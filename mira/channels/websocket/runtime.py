"""WebSocket server channel: mira acts as a WebSocket server and serves connected clients."""
...
from mira.webui.cli_apps_api import normalize_cli_app_mentions
from mira.webui.forking import handle_webui_fork_chat
from mira.webui.gateway_services import GatewayServices
...
class WebSocketConfig(Base):
    ...
    - ``token_issue_path``: If non-empty, **GET** (HTTP/1.1) to this path returns JSON
      ...
      mira and shares the asyncio loop, use a thread or async HTTP client for GET—do not call
