"""Lightweight WebSocket test client for integration testing the mira WebSocket channel.

Provides an async ``WsTestClient`` class and token-issuance helpers that
integration tests can import and use directly::

    from mira.channels.websocket.tests.ws_test_client import WsTestClient
...
from mira.channels.websocket.runtime import WebSocketChannel
from mira.webui.http_utils import http_response
