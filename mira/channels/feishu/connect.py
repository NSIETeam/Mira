...
from mira.channels.connect import ChannelConnectError, QueryParams, query_first
from mira.channels.feishu import runtime as feishu
from mira.channels.feishu.instances import DEFAULT_INSTANCE_ID, validate_instance_id
...
def _default_instance_name(instance_id: str) -> str:
    return "mira" if instance_id == DEFAULT_INSTANCE_ID else f"mira {instance_id}"
