...
import type { miraFeaturesPayload } from "@/lib/types";
    ...
    <ChannelQrConnectFlow
      ...
      labels={{
        ...
        scanDescription: tx(
          ...
          "Use Feishu or Lark on your phone to scan this code. mira will finish setup automatically after authorization.",
        ),
