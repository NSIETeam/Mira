...
import { enablemiraFeature } from "@/lib/api";
import type {
...
function FeishuInstanceAction({
  ...
  const reconnect = async () => {
    ...
    try {
      onFeaturesUpdate(
        await enablemiraFeature(token, "feishu", { instanceId: instance.id }),
      );
    } catch (err) {
...
function defaultFeishuInstance(feature: miraFeatureInfo): miraChannelInstanceInfo {
  return {
    id: "default",
    name: "mira",
...
function instanceDisplayName(instance: miraChannelInstanceInfo): string {
