...
import mira.channels.whatsapp.runtime as whatsapp_module
from mira.bus.events import OutboundMessage
from mira.bus.queue import MessageBus
from mira.channels.whatsapp.runtime import (
    WhatsAppChannel,
...
async def test_unauthorized_dm_uses_base_pairing_flow(monkeypatch) -> None:
    _patch_neonize_api(monkeypatch)
    monkeypatch.setattr("mira.channels.base.generate_code", lambda _ch, _sid: "ABCD-EFGH")
