...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: mira plugins enable matrix"
    ) from e
...
from mira.config.paths import get_data_dir, get_media_dir
...
_MXC_IMAGE_PLACEHOLDER_PREFIX = "https://mira.invalid/matrix-mxc/"
