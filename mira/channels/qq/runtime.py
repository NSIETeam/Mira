...
- Publish to mira bus via BaseChannel._handle_message()
...
class QQConfig(Base):
    ...
    # Optional: directory to save inbound attachments. If empty, use mira get_media_dir("qq").
    media_dir: str = ""
...
class QQChannel(BaseChannel):
    ...
    async def start(self) -> None:
        ...
        if not QQ_AVAILABLE:
            self.logger.error("SDK not installed. Run: mira plugins enable qq")
            return
