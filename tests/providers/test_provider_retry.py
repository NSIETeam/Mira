...
from mira.providers.base import RETRY_AFTER_BUFFER, GenerationSettings, LLMProvider, LLMResponse
...
async def test_chat_with_retry_retries_transient_error_then_succeeds(monkeypatch) -> None:
    ...
    monkeypatch.setattr("mira.providers.base.asyncio.sleep", _fake_sleep)
