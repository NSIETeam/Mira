...
from mira.agent.tools.filesystem import WriteFileTool
...
from mira.session.webui_turns import WebuiTurnCoordinator, WebuiTurnRoutePolicy
from mira.utils.progress_events import (
...
class TestToolEventProgress:
    ...
    async def test_file_edit_snapshot_skipped_when_progress_callback_cannot_emit_file_edits(
        ...
        monkeypatch.setattr(
            "mira.agent.hooks.file_edit_activity.prepare_file_edit_trackers",
