...
async def test_drain_injections_passes_limit_to_callback_when_supported():
    ...
    from mira.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunner
    from mira.bus.events import InboundMessage
...
async def test_injection_cycles_capped_at_max():
    ...
    from mira.agent.runner import _MAX_INJECTION_CYCLES, AgentRunner
    from mira.bus.events import InboundMessage
...
async def test_cron_turn_deferred_while_session_active(tmp_path):
    ...
    from mira.bus.events import InboundMessage
    from mira.cron.session_turns import (
...
async def test_submitted_cron_turn_reports_pending_until_completed(tmp_path):
    ...
    from mira.cron.session_turns import CRON_TRIGGER_META
...
async def test_pending_queue_preserves_overflow_for_next_injection_cycle(tmp_path):
    ...
    from mira.agent.loop import AgentLoop
    from mira.agent.runner import _MAX_INJECTIONS_PER_TURN
    from mira.bus.events import InboundMessage
    from mira.bus.queue import MessageBus
...
async def test_drain_injections_on_empty_final_response():
    ...
    from mira.agent.runner import _MAX_EMPTY_RETRIES, AgentRunner
    from mira.bus.events import InboundMessage
