...
from mira.providers.base import GenerationSettings, LLMProvider, LLMResponse, ToolCallRequest
...
async def test_next_turn_after_llm_error_keeps_turn_boundary(tmp_path):
    from mira.agent.loop import AgentLoop
    from mira.agent.runner import _PERSISTED_MODEL_ERROR_PLACEHOLDER
    from mira.bus.events import InboundMessage
    from mira.bus.queue import MessageBus
