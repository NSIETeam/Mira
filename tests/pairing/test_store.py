...
from mira.pairing import __all__ as pairing_all
from mira.pairing import store


def test_all_exports_are_importable():
    """Every name in __all__ must actually be importable from mira.pairing."""
    import mira.pairing as pkg
