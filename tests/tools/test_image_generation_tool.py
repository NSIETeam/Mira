...
from mira.config.schema import ImageGenerationToolConfig, ProviderConfig
from mira.providers.image_generation import GeneratedImageResponse
...
async def test_generate_image_tool_stores_artifact_and_source_images(
    ...
    monkeypatch.setattr(
        "mira.agent.tools.image_generation.get_image_gen_provider",
