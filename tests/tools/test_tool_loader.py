...
from mira.agent.tools.loader import _SKIP_MODULES, ToolLoader
...
def test_fs_tool_create_builds_from_context():
    from mira.agent.tools.filesystem import ReadFileTool
...
def test_exec_tool_config_cls():
    from mira.agent.tools.shell import ExecTool, ExecToolConfig
...
def test_web_tools_config_cls():
    from mira.agent.tools.web import WebFetchTool, WebSearchTool, WebToolsConfig
...
def test_web_fetch_tool_create():
    from mira.agent.tools.web import WebFetchTool
    mock_config = MagicMock()
    mock_config.web.enable = True
...
def test_image_gen_tool_config_cls():
    from mira.agent.tools.image_generation import ImageGenerationTool, ImageGenerationToolConfig
...
def test_image_gen_tool_enabled():
    from mira.agent.tools.image_generation import ImageGenerationTool
    mock_config = MagicMock()
...
def test_my_tool_config_cls():
    from mira.agent.tools.self import MyTool, MyToolConfig
...
def test_mcp_wrappers_not_discoverable():
    from mira.agent.tools.mcp import MCPPromptWrapper, MCPResourceWrapper, MCPToolWrapper
