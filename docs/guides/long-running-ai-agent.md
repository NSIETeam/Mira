# How to Run a Long-Running AI Agent with mira

mira can keep agent work alive across turns through sustained goals,
...
so mira can link it to the correct session and workspace.
