# How AI Agent Memory Works in mira

This guide explains how to use mira's long-term AI agent memory: session
...
ground for every raw transcript; mira separates short-term messages from
...
- [AI Agent Memory in mira](../memory.md)
