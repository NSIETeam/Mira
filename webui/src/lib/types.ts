...
/**
 * GUI surface only. Keep runtime ownership in the kernel; the GUI merely
 * renders through a browser shell or a native host shell.
 */
export type RuntimeSurface = "browser" | "native";
export type KernelGuiSurface = RuntimeSurface;
 ...
 *
 * The current WebUI still handles richer websocket events directly in places.
 * New GUI-facing surfaces should prefer this shape so they depend on kernel
 * semantics instead of provider/tool transport details.
 */
