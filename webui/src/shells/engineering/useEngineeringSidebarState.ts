...
export function useEngineeringSidebarState({
  ...
  const sidebarProps = useMemo(
    () => ({
      ...
      viewState: {
        density: sidebarState.view.density ?? "comfortable",
        show_previews: sidebarState.view.show_previews ?? true,
        show_timestamps: sidebarState.view.show_timestamps ?? true,
        show_archived: sidebarState.view.show_archived,
        sort: sidebarState.view.sort ?? "updated_desc",
      },
