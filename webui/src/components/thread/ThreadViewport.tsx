      ...
      >
        <div
          ...
          className={cn(
            ...
            hasMessages
              ? "max-w-[64rem]"
              : "max-w-[54rem] px-3 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-4 sm:px-4 sm:py-6",
          )}
        >
          {hasMessages ? (
            <div
            ...
            <div className="row-start-1 flex min-h-0 w-full min-w-0 items-end justify-center pb-3 sm:pb-4">
              {emptyState}
            </div>
          )}
