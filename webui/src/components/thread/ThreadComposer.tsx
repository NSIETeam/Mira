  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "thread-composer-surface group/composer relative mx-auto flex w-full min-w-0 flex-col overflow-visible border border-slate-300/70 bg-white shadow-[0_20px_70px_rgba(15,23,42,0.14)] transition-all duration-200 focus-within:border-slate-900 focus-within:shadow-[0_24px_80px_rgba(15,23,42,0.18)] dark:border-white/15 dark:bg-card",
          isHero
            ? "max-w-[54rem] rounded-[26px]"
